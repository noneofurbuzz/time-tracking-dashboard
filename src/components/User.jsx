export default function User(prop){
    return(
        ...
        <img src={prop.darkMode ? "/images/moon-on.svg" : "/images/moon.svg"} alt="moon" className="block"></img>
        <img src={prop.darkMode ? "/images/toggle-off.svg" : "/images/toggle-on.svg"} alt="toggle" className="mx-3 ml-5  hover:cursor-pointer block "onClick={prop.toggleSwitch}></img>
        <img src={prop.darkMode ? "/images/sun.svg" : "/images/sun-on.svg"} alt="sun" className="mr-6 px-0 block "></img>
        </div>
